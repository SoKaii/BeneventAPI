...
INSERT INTO event(name, description, startdate, enddate, location, maxbenevole, idcategory, idassociation, fakeevent) VALUES("Accompagnement définition et développement marketing", "Le volontaire devra animer un processus de réflexion avec l’équipe de Escuela para el Desarrollo afin des les amener à réfléchir sur leur offre de services actuelle, analyser leur forces et faiblesse.", "2020-06-11 08:00:00", "2020-06-12 18:00:00", "76-78, rue Saint-Lazare, 75009, Le Créatif", 1, 3, 6, false);
...
INSERT INTO event(name, description, startdate, enddate, location, maxbenevole, idcategory, idassociation, fakeevent) VALUES("Soutien à la maintenance d’un systèmes solaire", "Terre, Paille et Compagnie dispose d’un système de chauffage qui n’est pas optimal. L’amélioration du système de chauffage d’eau et d’installation des panneaux solaires permettrait une meilleure exploitation.", "2020-09-10 08:00:00", "2020-09-24 18:00:00", "La Courdemière, 86160, Terre Paille & Compagnie", 1, 3, 6, false);
